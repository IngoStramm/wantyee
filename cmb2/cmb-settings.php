...
function wt_register_theme_options_metabox()
{
    ...
    $cmb_options->add_field(array(
        'name'    => esc_html__('Página dos anúncios das categorias que o vendedor segue', 'wt'),
        'id'      => 'wt_following_terms_anuncios_page',
        'type'    => 'select',
        'options' => function () {
            $pages = wt_get_pages();
            $array = [];
    ...
    $cmb_options->add_field(array(
        'name'    => esc_html__('Página do Relatório', 'wt'),
        'id'      => 'wt_report_page',
        'type'    => 'select',
        'options' => function () {
            $pages = wt_get_pages();
    ...
    $cmb_options->add_field(array(
        'name'    => esc_html__('Página do Perfil do Vendedor', 'wt'),
        'id'      => 'wt_perfil_vendedor_page',
        'type'    => 'select',
        'options' => function () {
            $pages = wt_get_pages();
            $array = [];
